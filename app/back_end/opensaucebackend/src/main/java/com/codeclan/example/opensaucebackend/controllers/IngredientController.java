...
public class IngredientController {
    ...
    @GetMapping(value ="/getcocktails/{id}")
    public List<Cocktail> getAllCocktailsForIngredient(@PathVariable long id){
        return ingredientRepository.getAllCocktailsForIngredientByID(id);
    }
